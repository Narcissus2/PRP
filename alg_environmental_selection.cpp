...
size_t FindNicheReferencePoint(const vector<CReferencePoint> &rps)
{
	...
	//cout << "find the minimal cluster size\n";
	...
	//cout << "find the reference points with the minimal cluster\n";
...
{
    //cout << "it's in EnvironmentalSelection\n";
	...
	//cout << "CNondominatedSort::TFronts fronts\n";
